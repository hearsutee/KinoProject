...
}(function (a, b)
{
    ...
    }(), f = function ()
    {
    ...
    }(), g = {version: "0.5.2", options: {width: null, height: null, minHeight: null, maxHeight: null, focus: !1, tabsize: 4, styleWithSpan: !0, disableLinkTarget: !1, disableDragAndDrop: !1, disableResizeEditor: !1, codemirror: {mode: "text/html", lineNumbers: !0}, lang: "en-US", direction: null, toolbar: [
        ["style", ["style"]],
        ...
        ["table", ["table"]],
        ["insert", ["link", "picture"]]
    ], styleTags: ["p", "blockquote", "pre", "h1", "h2", "h3", "h4", "h5", "h6"], defaultFontName: "Arial", fontNames: ["Serif", "Sans", "Arial", "Arial Black", "Courier", "Courier New", "Comic Sans MS", "Helvetica", "Impact", "Lucida Grande", "Lucida Sans", "Tahoma", "Times", "Times New Roman", "Verdana"], colors: [
    ...
    }, m = function ()
    {
        ...
        }, g = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "insertOrderedList", "insertUnorderedList", "indent", "outdent", "formatBlock", "removeFormat", "backColor", "foreColor", "insertHorizontalRule", "fontName"], i = 0, m = g.length; m > i; i++)this[g[i]] = function (a)
        {
            return function (b, c)
            {
        ...
        }, this.createLink = function (b, d, g, h)
        {
            ...
            } else document.execCommand("createlink", !1, j);
    ...
    }, q = function ()
    {
        ...
        this.update = function (a, g, h)
        {
            ...
            if (g.image ? c(k, g.image) : k.hide(), h)
            {
                ...
                if (g.range.isCollapsed())l.hide(); else
                {
    ...
    }, t = function ()
    {
        ...
        }, D = function (b)
        {
            ...
            if (c.length > 0)
            {
                ...
                } else if ("showImageDialog" === f)m.focus(), o.showImageDialog(m, l).then(function (a)
                {
                ...
                } else"showHelpDialog" === f ? o.showHelpDialog(m, l) : "fullscreen" === f ? B(i) : "codeview" === f && C(i);
                w(b)
            }
        }, E = 24, F = function (a)
        {
    ...
    }, u = function ()
    {
        ...
        }}, j = function (a, c)
        {
            ...
            }, h = function ()
            {
                for (var b = "", d = 0, e = c.airPopover.length; e > d; d++)
                {
                    ...
                    for (var h = 0, j = f[1].length; j > h; h++)b += i[f[1][h]](a, c);
                    b += "</div>"
                }
        ...
        {
            return c.bMac && (a = a.replace("CMD", "âŒ˜").replace("SHIFT", "â‡§")), a.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")
        }, w = function (b, c, e)
        {
        ...
        }, this.createLayoutByFrame = function (b, d)
        {
            ...
            for (var l = a.summernote.lang[d.lang], m = "", n = 0, o = d.toolbar.length; o > n; n++)
            {
                ...
                for (var q = 0, r = p[1].length; r > q; q++)m += i[p[1][q]](l, d);
                m += "</div>"
            }
