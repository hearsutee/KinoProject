                ...
                {type: "vbox", padding: 0, children: [
                    {type: "hbox", widths: ["70%", "30%"], children: [
                        ...
                        {type: "select", id: "widthType",
                            label: g.lang.table.widthUnit, labelStyle: "visibility:hidden", "default": "px", items: [
                            [h.widthPx, "px"],
                            [h.widthPc, "%"]
                        ], setup: d(j)}
                    ]},
                ...
                {type: "vbox",
                    ...
                    {type: "hbox", padding: 0, widths: ["60%", "40%"], children: [
                        {type: "text", id: "bgColor", label: c.bgColor, "default": "", setup: d(function (a)
                        {
                            ...
                            return a.getStyle("background-color") ||
                                b
                        }), commit: function (a)
                        {
                        ...
                        k ? {type: "button", id: "bgColorChoose", "class": "colorChooser", label: c.chooseColor, onLoad: function ()
                        {
                    ...
                    {type: "hbox", padding: 0, widths: ["60%", "40%"],
                        children: [
                            ...
                            k ? {type: "button", id: "borderColorChoose", "class": "colorChooser", label: c.chooseColor, style: (m ? "margin-right" : "margin-left") + ": 10px", onLoad: function ()
                            {
